...
class LayListMcVehicleSc extends StatelessWidget {
  LayListMcVehicleSc({super.key});

  final MapsMcScController controller = Get.put(MapsMcScController());
  final MapsStreetCleaningController mapsMonitoringC =
                    ...
                    onTap: () {
                      if (controller.filterDateC.text == '') {
                        ...
                        if (mapsMonitoringC.firstHourFilter.value == 0 &&
                          ...
                          WarningWidget().dialog('Required First Time and Last Time');
                        } else {

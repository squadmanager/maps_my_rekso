...
import 'package:maps_my_rekso/app/widgets/photo_view_widget.dart';

class DetailVehicleSc extends GetView<MapsStreetCleaningController> {
  final element;
  const DetailVehicleSc({required this.element, super.key});

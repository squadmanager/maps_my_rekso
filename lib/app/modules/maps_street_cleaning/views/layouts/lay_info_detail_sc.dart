...
class LayInfoDetailSc extends GetView<MapsStreetCleaningController> {
  const LayInfoDetailSc({super.key});
...
class InfoDetailVehicleSc extends GetView<MapsStreetCleaningController> {
  const InfoDetailVehicleSc({super.key});

...
import 'package:maps_my_rekso/app/widgets/card_no_elevation_widget.dart';
import 'package:maps_my_rekso/app/widgets/color_widget.dart';
import 'package:maps_my_rekso/app/widgets/input_widget.dart';

class SearchMapWidget extends GetView<MapsWasteCollectionsController> {
      ...
      child: CardNoElevationWidget(
        ...
        onTap: () async {
          ...
          controller.gotoLocation(
            ...
            double.parse(data['longititude']),
            18,
          );
        },
        title: '${data['location_task']}',
